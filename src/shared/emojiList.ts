...
export const emojiList: EmojiList = [
	...
	[
		...
		['\u{1F44C}', '\u{1F90F}', '\u{270C}', '\u{1F91E}', '\u{1F91F}', '\u{1F918}', '\u{1F919}'],
	],
	[
		'hand-single-finger',
	...
	['dishware', ['\u{1F962}', '\u{1F37D}', '\u{1F374}', '\u{1F944}', '\u{1F52A}', '\u{1F3FA}']],
	[
		'place-map',
		['\u{1F30D}', '\u{1F30E}', '\u{1F30F}', '\u{1F310}', '\u{1F5FA}', '\u{1F5FE}', '\u{1F9ED}'],
	],
	[
		'place-geographic',
		[
	...
	['arts & crafts', ['\u{1F3AD}', '\u{1F5BC}', '\u{1F3A8}', '\u{1F9F5}', '\u{1F9F6}', '\u{1FAA2}']],
	[
		'clothing',
		[
			'\u{1F453}',
	...
	[
		'musical-instrument',
		['\u{1F3B7}', '\u{1F3B8}', '\u{1F3B9}', '\u{1F3BA}', '\u{1F3BB}', '\u{1FA95}', '\u{1F941}'],
	],
	...
	[
		'writing',
		['\u{270F}', '\u{2712}', '\u{1F58B}', '\u{1F58A}', '\u{1F58C}', '\u{1F58D}', '\u{1F4DD}'],
	],
	[
		'office',
		[
	...
	[
		'science',
		['\u{2697}', '\u{1F9EA}', '\u{1F9EB}', '\u{1F9EC}', '\u{1F52C}', '\u{1F52D}', '\u{1F4E1}'],
	],
	['medical', ['\u{1F489}', '\u{1FA78}', '\u{1F48A}', '\u{1FA79}', '\u{1FA7A}']],
	[
		'household',
		[
			'\u{1F6AA}',
	...
	['math', ['\u{2716}', '\u{2795}', '\u{2796}', '\u{2797}', '\u{267E}']],
	[
		'punctuation',
